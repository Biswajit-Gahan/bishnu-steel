...
const QuotationModal = ({ productType = "round", clickEvent }) => {
  ...
  const [buttonState, setButtonState] = useState(() => ({
    isError: false, isSuccess: false, isLoading: false, isChecked: false
  }));
  ...
  const handleInputs = ({ target }) => {
    setButtonState((prevData) => ({ ...prevData, isError: false, isLoading: false, isSuccess: false }));
  ...
  const handleRequest = async () => {
    if (buttonState.isChecked && !buttonState.isLoading) {
      ...
      try {
        ...
        const { data } = await sendMail.post(process.env.REACT_APP_EMAIL_SEND_API, {
          toEmail, subject, content
        });

        if (data.statusCode === 200) {
          setButtonState((prevData) => ({ ...prevData, isLoading: false, isSuccess: true, isError: false }));
          setAllInputs(() => ({ username: "", useremail: "", usermobile: "", company: "", productType, thickness: "", gradeType: "201", quantity: "", exReq: "" }));
        } else {
          setButtonState((prevData) => ({ ...prevData, isLoading: false, isError: true }));
        }
      ...
      <div className="quotation-form-container">
          ...
          <div className="your-details-inputs-container input-container">
            ...
            <div className="input-container-stack">
              ...
              <div className="inputs-container">
                ...
                <input value={allInputs.username} type="text" id="username" className="name-input input" placeholder="your full name..." onInput={handleInputs} />
              </div>

              {/* INPUTS CONTAINER */}
              <div className="inputs-container">
                <label htmlFor="useremail" className="input-label">Email ID</label>
                <input value={allInputs.useremail} type="email" id="useremail" className="email-input input" placeholder="your email id..." onInput={handleInputs} />
              </div>
            </div>
            ...
            <div className="input-container-stack">
              ...
              <div className="inputs-container">
                ...
                <input value={allInputs.usermobile} type="text" id="usermobile" className="mobile-input input" placeholder="your mobile number..." onInput={handleInputs} />
              </div>

              {/* INPUTS CONTAINER */}
              <div className="inputs-container">
                <label htmlFor="company" className="input-label">Company Name</label>
                <input value={allInputs.company} type="text" id="company" className="company-input input" placeholder="your company name..." onInput={handleInputs} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="productType-inputs-container input-container">
            ...
            <div className="input-container-stack">
              ...
              <div className="inputs-container">
                ...
                <select value={allInputs.productType} id="productType" className="productType-select input" onChange={handleInputs}>
              ...
              <div className="inputs-container">
                ...
                <input value={allInputs.thickness} type="text" id="thickness" className="thickness-input input" placeholder="eg: 0.3mm - 3.0mm" onInput={handleInputs} />
              </div>
            </div>
            ...
            <div className="input-container-stack">
              ...
              <div className="inputs-container">
                ...
                <select value={allInputs.gradeType} id="gradeType" className="gradeType-select input" onChange={handleInputs}>
              ...
              <div className="inputs-container">
                ...
                <input value={allInputs.quantity} type="text" id="quantity" className="quantity-input input" placeholder="quantity in tons..." onInput={handleInputs} />
              </div>
            </div>
            ...
            <div className="input-container-stack">
              ...
              <div className="inputs-container">
                ...
                <textarea value={allInputs.exReq} type="text" id="exReq" className="text-area-input input" placeholder="please specify your addition requirements, if any..." onInput={handleInputs} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="buttons-container">
          <button
            ...
            style={{ cursor: buttonState.isChecked ? "pointer" : "not-allowed" }}
          >
            {
              buttonState.isLoading
                ? <><RestartAltIcon /> Please Wait...</>
                : buttonState.isError
                  ? <><ErrorOutlineIcon />Error, Please Send Again!</>
                  : buttonState.isSuccess
                    ? <><DoneAllIcon />Sent Successfully.</>
                    : <><SendRoundedIcon />Request Quotation</>
            }
          </button>
          <button type="button" className="close-button modal-button" onClick={clickEvent}><CloseIcon />Close</button>
        </div>
      </div>
    </QuotationModalContainer>,
